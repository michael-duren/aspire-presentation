...
redundency in place. If you are using a cloud provider
...
If you have a lot of services you want to hide from
your frontend, Gateways achieve this by essentially
providing a reverse proxy for the frontend to call.
...
so having a high amount of redundancy is important.
